# MobileNets: An efficient and faster Convolutional Neural Networks for Mobile Vision Applications
...
| 5x (Conv dw/s1, conv/s1) | 3 x 3 x 256 dw
...
| La-yers | I/O feature map size (Stored in Internal Memory) | Internal Memory used (bits) | Data Mov. size (bits) |
| --- | --- | --- | --- |
...
| Memory limit exceeded, so data is moved. |
...
| La-yers | Data Movement Time (sec, A) | Compute Time (sec, B) | Performance Time (sec, A+B) |
| --- | --- | --- | --- |
...
| Total Performance Time = 0.001340632 |
